...
Import-Module -Name PowerValidatedSolutions -MinimumVersion
...
$certPath = "C:\VLC-New\CertGenVVS\SignedByMSCACerts\RootCA\Root64.cer"
...
$wsaOvaPath = "C:\VLC-New\OVAs\identity-manager-3.3.5.0-18049997_OVF10.ova"
...
$wsaCertKeyPath = "C:\VLC-New\CertGenVVS\SignedByMSCACerts\cmi-wsa01\cmi-wsa01.key"
$wsaCertPath = "C:\VLC-New\CertGenVVS\SignedByMSCACerts\cmi-wsa01\cmi-wsa01.7.crt"
...
Add-NsxtVidmGroupRole -server $sddcManagerFqdn -user $sddcManagerUser -pass $sddcManagerPass -domain $sddcDomainName -group $nsxEnterpriseAdminGroup -role enterprise_admin
Add-NsxtVidmGroupRole -server $sddcManagerFqdn -user $sddcManagerUser -pass $sddcManagerPass -domain $sddcDomainName -group $nsxNetworkEngineerGroup -role network_engineer
Add-NsxtVidmGroupRole -server $sddcManagerFqdn -user $sddcManagerUser -pass $sddcManagerPass -domain $sddcDomainName -group $nsxAuditorGroup -role auditor
...
$roleTmplPath = "C:\Program Files\WindowsPowerShell\Modules\PowerValidatedSolutions\1.0.1\vSphereRoles\nsx-vsphere-integration.role"
